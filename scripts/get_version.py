#!/usr/bin/env python3
"""Extract semantic version from src/BinXray/Version.h."""
...
def read_version_header(path: pathlib.Path) -> tuple[int, int, int]:
    ...
    major = get_macro("BXR_VERSION_MAJOR")
    minor = get_macro("BXR_VERSION_MINOR")
    patch = get_macro("BXR_VERSION_PATCH")
